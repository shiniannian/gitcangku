...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageView topShowIv;
    SharedPreferences preferences;      //设置预算时所使用
    @Override
    ...
    private void showDeleteItemDialog(final  AccountBean clickBean) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);    //得到Builder对象
    ...
    protected void onResume() {
        super.onResume();
        loadDBData();
        setTopTvShow();     //设置顶部布局的TextView的显示
    }
...
//    设置显示运算剩余
    ...
    private void loadDBData() {
        List<AccountBean> list = DBManager.getAccountListOneDayFromAccounttb(year, month, day); //这个list就属于数据库中调查出来的属于今天的信息
        mDatas.clear();
        mDatas.addAll(list);
